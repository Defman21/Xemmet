...
function loadIntoWindow(window) {
    try {
        window.require.setRequirePath("xemmet/", "chrome://xemmet/content/");
        window.require("xemmet").load();
    } catch (e) {
        Cu.reportError("Xemmet: Exception while loading Xemmet");
        Cu.reportError(e);
    }
}
